...
Copied from [EL Specs](https://github.com/MariusVanDerWijden/execution-apis/blob/e509f20f9e9107c262bc65a46ea71cb3c8d19a7d/src/engine/refactor.md)
...
- [Engine API v2 -- SSZ Container Sketches (Amsterdam)](#engine-api-v2----ssz-container-sketches-amsterdam)
  - [Table of contents](#table-of-contents)
  - [Primitive aliases](#primitive-aliases)
  - [`MAX_*` constants](#max_-constants)
  ...
  - [Endpoint containers](#endpoint-containers)
    - [`POST /{fork}/payloads`](#post-forkpayloads)
      - [Request (Amsterdam)](#request-amsterdam)
      - [Response](#response)
    - [`POST /{fork}/forkchoice`](#post-forkforkchoice)
      - [Request (Amsterdam)](#request-amsterdam-1)
      - [Response (all forks)](#response-all-forks)
    - [`GET /{fork}/payloads/{payloadId}`](#get-forkpayloadspayloadid)
      - [Response (Amsterdam)](#response-amsterdam)
    - [`POST /{fork}/bodies/hash` and `GET /{fork}/bodies?...`](#post-forkbodieshash-and-get-forkbodies)
      - [Request — `/bodies/hash`](#request--bodieshash)
      - [Request — `/bodies?from=N&count=M`](#request--bodiesfromncountm)
      - [Response](#response-1)
    - [`POST /blobs/v1`](#post-blobsv1)
      - [Request](#request)
      - [Response](#response-2)
    - [`POST /blobs/v2`](#post-blobsv2)
      - [Request — same as `/v1`](#request--same-as-v1)
      - [Response](#response-3)
    - [`POST /blobs/v3`](#post-blobsv3)
      - [Request — same as `/v2`](#request--same-as-v2)
      - [Response](#response-4)
